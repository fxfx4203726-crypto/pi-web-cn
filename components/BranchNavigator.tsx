    ...
    return (
      <div style={{ height: "100%", display: "flex", alignItems: "stretch" }}>
        <button
          ...
          onMouseEnter={(e) => { e.currentTarget.style.color = "var(--text)"; e.currentTarget.style.background = "rgba(255,255,255,0.75)"; e.currentTarget.style.boxShadow = "0 6px 18px rgba(0,0,0,0.08), 0 2px 4px rgba(0,0,0,0.04), inset 0 1px 0 rgba(255,255,255,0.9)"; e.currentTarget.style.transform = "translateY(-1px)"; }}
          onMouseLeave={(e) => { e.currentTarget.style.color = open ? "var(--text)" : "var(--text-muted)"; e.currentTarget.style.background = open ? "rgba(255,255,255,0.7)" : "rgba(255,255,255,0.45)"; e.currentTarget.style.boxShadow = open ? "0 4px 12px rgba(0,0,0,0.08), 0 1px 3px rgba(0,0,0,0.04), inset 0 1px 0 rgba(255,255,255,0.9)" : "0 2px 6px rgba(0,0,0,0.06), 0 1px 2px rgba(0,0,0,0.04), inset 0 1px 0 rgba(255,255,255,0.7)"; e.currentTarget.style.transform = "translateY(0)"; }}
        >
          {branchIcon}
          <span>Branches</span>
        </button>
