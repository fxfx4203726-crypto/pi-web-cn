      ...
      <div style={{ display: "flex", alignItems: "flex-end", gap: 8, maxWidth: "82%" }}>
        <div
          style={{
            ...
            boxShadow: "0 1px 3px rgba(0,122,255,0.2), 0 4px 12px rgba(0,122,255,0.1)",
              ...
              {imageBlocks.map((img, i) => {
                ...
                return (
                  ...
                  <img
                    ...
                    src={src}
                    alt=""
                    style={{ maxWidth: 240, maxHeight: 240, borderRadius: 8, objectFit: "contain", display: "block", border: "1px solid rgba(255,255,255,0.25)" }}
                  />
                );
              })}
            </div>
            ...
            <div style={{
              ...
              {canFork && (
                <button
                  ...
                  disabled={forking}
                  title={forking ? "创建新会话…" : "新会话 — 从此处创建独立副本"}
                  style={{
                    display: "flex", alignItems: "center", gap: 4,
                    padding: "3px 8px", height: 22,
                    background: "none", border: "none",
  ...
  return (
    ...
    >
      ...
      >
        ...
        <svg width="10" height="10" viewBox="0 0 10 10" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0, transform: expanded ? "rotate(180deg)" : "none", transition: "transform 0.2s", opacity: 0.5 }}>
  ...
  return (
    <div
      style={{
        ...
        boxShadow: "0 1px 3px rgba(0,0,0,0.02), inset 0 1px 0 rgba(255,255,255,0.4)",
      }}
    >
      {/* ── Tool call header ── */}
      <button
      ...
      {expanded && (
        <pre
          style={{
            ...
            borderTop: isError ? "1px solid rgba(239,68,68,0.12)" : "1px solid rgba(34,197,94,0.1)",
            whiteSpace: "pre-wrap",
            wordBreak: "break-all",
          }}
        >
...
function PairedResult({ text, isEmpty, isError }: {
  ...
  return (
    <div
      style={{
        borderTop: `1px solid ${isError ? "rgba(239,68,68,0.12)" : "rgba(34,197,94,0.1)"}`,
        background: isError ? "rgba(239,68,68,0.04)" : "rgba(255,255,255,0.15)",
      }}
    >
      <pre
        style={{
          margin: 0,
          padding: "10px 14px",
          color: isError ? "#ef4444" : (isEmpty ? "var(--text-dim)" : "var(--text-muted)"),
          fontSize: 12,
          lineHeight: 1.55,
          overflow: "auto",
          maxHeight: 400,
  ...
  return (
    <div
      style={{
        ...
        boxShadow: "0 1px 3px rgba(0,0,0,0.04), inset 0 1px 0 rgba(255,255,255,0.3)",
      }}
    >
      <div
        style={{
      ...
      >
        <span style={{ fontWeight: 500, fontFamily: "var(--font-mono)", fontSize: 10, textTransform: "uppercase", letterSpacing: "0.04em" }}>{lang}</span>
        <button
          onClick={copy}
          style={{
            background: "none",
          ...
          onMouseEnter={(e) => { e.currentTarget.style.background = "rgba(255,255,255,0.3)"; e.currentTarget.style.color = "var(--text)"; }}
