  ...
  return (
    ...
    >
      ...
      <div style={{ maxWidth: 820, margin: "0 auto" }}>
        ...
        {/* Main input — Apple-style floating card */}
        <div
          ...
          {isStreaming ? (
            ...
            <button
              ...
              style={{
                ...
                cursor: (value.trim() || attachedImages.length) ? "pointer" : "not-allowed",
                padding: 0,
                boxShadow: (value.trim() || attachedImages.length) ? "0 2px 8px rgba(0,122,255,0.35)" : "none",
                transition: "background 0.2s, box-shadow 0.2s, transform 0.15s",
              }}
              onMouseEnter={(e) => {
                if (value.trim() || attachedImages.length) {
                  e.currentTarget.style.transform = "scale(1.05)";
                  e.currentTarget.style.boxShadow = "0 4px 14px rgba(0,122,255,0.45)";
                }
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.transform = "scale(1)";
                e.currentTarget.style.boxShadow = (value.trim() || attachedImages.length) ? "0 2px 8px rgba(0,122,255,0.35)" : "none";
              }}
            >
                ...
                <div ref={dropdownRef} style={{ position: "relative" }}>
                  ...
                  {modelDropdownOpen && (
                    <div ref={modelDropdownPanelRef} style={{
                      ...
                      borderRadius: 10, boxShadow: "0 -8px 32px rgba(0,0,0,0.10), 0 -2px 8px rgba(0,0,0,0.06)",
                      overflow: "hidden", width: "max-content", minWidth: 180, maxHeight: "min(400px, 50vh)", overflowY: "auto",
                    }}>
