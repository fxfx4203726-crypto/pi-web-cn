        ...
        {([
          ...
          <button
            ...
            style={{
              ...
              height: 34, padding: 0,
              background: disabled ? "transparent" : (isDark ? "rgba(255,255,255,0.08)" : "rgba(255,255,255,0.45)"),
              border: disabled ? "none" : (isDark ? "1px solid rgba(255,255,255,0.10)" : "1px solid rgba(255,255,255,0.55)"),
              borderRadius: 10,
            ...
            onMouseEnter={(e) => { if (!disabled) { e.currentTarget.style.background = isDark ? "rgba(255,255,255,0.14)" : "rgba(255,255,255,0.75)"; e.currentTarget.style.color = "var(--text)"; e.currentTarget.style.boxShadow = isDark ? "0 6px 16px rgba(0,0,0,0.20), 0 2px 4px rgba(0,0,0,0.10), inset 0 1px 0 rgba(255,255,255,0.06)" : "0 6px 16px rgba(0,0,0,0.08), 0 2px 4px rgba(0,0,0,0.04), inset 0 1px 0 rgba(255,255,255,0.9)"; e.currentTarget.style.transform = "translateY(-1px)"; } }}
            onMouseLeave={(e) => { e.currentTarget.style.background = isDark ? "rgba(255,255,255,0.08)" : "rgba(255,255,255,0.45)"; e.currentTarget.style.color = "var(--text-muted)"; e.currentTarget.style.boxShadow = isDark ? "0 2px 6px rgba(0,0,0,0.15), 0 1px 2px rgba(0,0,0,0.10), inset 0 1px 0 rgba(255,255,255,0.04)" : "0 2px 6px rgba(0,0,0,0.06), 0 1px 2px rgba(0,0,0,0.04), inset 0 1px 0 rgba(255,255,255,0.7)"; e.currentTarget.style.transform = "translateY(0)"; }}
          >
            {icon}
            {label}
          </button>
  ...
  return (
    ...
    <div style={{ display: "flex", height: "100dvh", overflow: "hidden", background: "var(--bg)" }}>
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden", minWidth: 0 }}>
        {/* Top bar with traffic lights + logo + actions */}
        <div ref={topBarRef} style={{ display: "flex", alignItems: "center", flexShrink: 0, borderBottom: "1px solid var(--border)", height: 44, background: "var(--bg-panel)", backdropFilter: "blur(20px) saturate(180%)", WebkitBackdropFilter: "blur(20px) saturate(180%)", paddingLeft: 14, paddingRight: 12, gap: 4 }}>
          {/* Mac-style traffic lights — functional */}
          <div style={{ display: "flex", alignItems: "center", gap: 6, flexShrink: 0, marginRight: 6 }}>
            <button
              onClick={() => { if (typeof window !== "undefined") window.close(); }}
              title="关闭"
              style={{ width: 10, height: 10, borderRadius: "50%", background: "#ff5f57", display: "inline-block", boxShadow: "inset 0 0 0 0.5px rgba(0,0,0,0.06)", border: "none", padding: 0, cursor: "pointer", flexShrink: 0 }}
            />
            <button
              onClick={() => setSidebarOpen((v) => !v)}
              title={sidebarOpen ? "收起侧边栏" : "展开侧边栏"}
              style={{ width: 10, height: 10, borderRadius: "50%", background: "#febc2e", display: "inline-block", boxShadow: "inset 0 0 0 0.5px rgba(0,0,0,0.06)", border: "none", padding: 0, cursor: "pointer", flexShrink: 0 }}
            />
            <button
              onClick={() => {
              ...
              title="全屏"
              style={{ width: 10, height: 10, borderRadius: "50%", background: "#28c840", display: "inline-block", boxShadow: "inset 0 0 0 0.5px rgba(0,0,0,0.06)", border: "none", padding: 0, cursor: "pointer", flexShrink: 0 }}
            />
          </div>
          {/* Logo */}
          <div style={{ display: "flex", alignItems: "center", gap: 6, flexShrink: 0 }}>
            <UpdateChecker />
            <span className="rz-logo-shimmer" style={{ fontSize: 15, fontWeight: 700, letterSpacing: "-0.02em" }}>Rz Agent</span>
          </div>
          {/* Small gap between logo and controls */}
          <div style={{ width: 16, flexShrink: 0 }} />
          {/* Right-side controls — kept close to logo */}
          <div style={{ display: "flex", alignItems: "center", gap: 6, flexShrink: 0 }}>
            <button
              onClick={(e) => {
              ...
              style={{
                ...
                color: "var(--text-muted)", cursor: "pointer", flexShrink: 0, transition: "all 0.2s cubic-bezier(0.25, 0.46, 0.45, 0.94)",
                borderRadius: 9,
                boxShadow: isDark
                  ? "0 2px 6px rgba(0,0,0,0.15), 0 1px 2px rgba(0,0,0,0.10), inset 0 1px 0 rgba(255,255,255,0.04)"
                  : "0 2px 6px rgba(0,0,0,0.06), 0 1px 2px rgba(0,0,0,0.04), inset 0 1px 0 rgba(255,255,255,0.7)",
              ...
              onMouseLeave={(e) => { e.currentTarget.style.color = "var(--text-muted)"; e.currentTarget.style.background = isDark ? "rgba(255,255,255,0.08)" : "rgba(255,255,255,0.45)"; e.currentTarget.style.boxShadow = isDark ? "0 2px 6px rgba(0,0,0,0.15), 0 1px 2px rgba(0,0,0,0.10), inset 0 1px 0 rgba(255,255,255,0.04)" : "0 2px 6px rgba(0,0,0,0.06), 0 1px 2px rgba(0,0,0,0.04), inset 0 1px 0 rgba(255,255,255,0.7)"; e.currentTarget.style.transform = "translateY(0)"; }}
            >
              {isDark ? (
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            {showChat && (
              <div style={{ display: "flex", alignItems: "center", gap: 2, height: "100%", flexShrink: 0 }}>
                <BranchNavigator
                  tree={branchTree}
                ...
                <button
                  ...
                  style={{
                    ...
                    background: activeTopPanel === "system"
                    ...
                    flexShrink: 0,
                    boxShadow: activeTopPanel === "system"
                      ? (isDark
          ...
          {/* Session stats — right-aligned, shrinks when space is tight */}
            ...
            return (
              <div
                ...
                style={{
                  ...
                  flexShrink: 1,
                  minWidth: 0,
                  maskImage: "linear-gradient(to left, transparent 0px, black 24px)",
                  WebkitMaskImage: "linear-gradient(to left, transparent 0px, black 24px)",
                }}
              >
                {t && t.input > 0 && (
              ...
              <div style={{ position: "absolute", top: 12, left: 12, display: "flex", alignItems: "flex-start", gap: 8, userSelect: "none", pointerEvents: "none" }}>
                ...
                <div>
                  ...
                  <div style={{ fontSize: 12, color: "var(--text-muted)", lineHeight: 1.8 }}>
                    <span style={{ color: "var(--text-dim)", marginRight: 6 }}>1.</span>在侧边栏选择一个项目目录<br />
      ...
      >
        {/* Right panel tab bar */}
        <div style={{ display: "flex", alignItems: "center", flexShrink: 0, background: "var(--bg-panel)", borderBottom: "1px solid var(--border)", height: 36, position: "relative", zIndex: 2 }}>
        ...
        {/* File content */}
        <div style={{ flex: 1, overflow: "hidden", background: "var(--bg)", position: "relative", zIndex: 1 }}>
          {activeFileTab?.filePath ? (
            <FileViewer filePath={activeFileTab.filePath} cwd={activeCwd ?? undefined} />
          ) : (
            <div className="right-panel-empty" style={{ height: "100%", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", color: "var(--text-dim)", fontSize: 12, gap: 10, padding: 24 }}>
              <div style={{
                ...
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round" style={{ opacity: 0.4 }}>
                  <rect x="3" y="3" width="18" height="18" rx="2" /><line x1="15" y1="3" x2="15" y2="21" /><line x1="9" y1="9" x2="15" y2="9" /><line x1="9" y1="15" x2="13" y2="15" />
                </svg>
              </div>
              <span style={{ fontSize: 13, color: "var(--text-muted)", fontWeight: 500 }}>暂无打开文件</span>
              <span style={{ fontSize: 11, color: "var(--text-dim)", textAlign: "center", lineHeight: 1.5 }}>从左侧资源管理器点击文件<br/>或让 AI 生成文件后自动打开</span>
            </div>
          )}
        </div>
      </div>
