...
// Unified glassmorphism avatar — no colors, clean frosted look
const AVATAR_STYLE = {
  bg: "rgba(255,255,255,0.42)",
  text: "var(--text-muted)",
  border: "1px solid rgba(255,255,255,0.55)",
  shadow: "0 2px 8px rgba(0,0,0,0.08), 0 1px 3px rgba(0,0,0,0.05), inset 0 1px 0 rgba(255,255,255,0.5)",
};

function getAvatarStyle(_sessionId: string) {
  return AVATAR_STYLE;
}
...
function PiAgentTitle() {
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
      <span style={{ fontSize: 16, fontWeight: 700, color: "var(--text)", letterSpacing: "-0.01em" }}>Rz Agent</span>
    </div>
  );
}
    ...
    <div style={{ display: "flex", flexDirection: "column", height: "100%", overflow: "hidden" }}>
      ...
      >
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 8 }}>
          <span style={{ fontSize: 11, fontWeight: 600, color: "var(--text-dim)", letterSpacing: "0.06em", textTransform: "uppercase" }}>最近对话</span>
          <div style={{ display: "flex", gap: 4 }}>
            <button
              ...
              onMouseEnter={(e) => {
                ...
                e.currentTarget.style.boxShadow = "0 3px 8px rgba(0,0,0,0.05), inset 0 1px 0 rgba(255,255,255,0.8)";
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.background = "rgba(255,255,255,0.4)";
                e.currentTarget.style.color = selectedCwd ? "var(--text-muted)" : "var(--text-dim)";
                e.currentTarget.style.boxShadow = "0 1px 2px rgba(0,0,0,0.03), inset 0 1px 0 rgba(255,255,255,0.6)";
              }}
            >
            ...
            <button
              ...
              style={{
                display: "flex", alignItems: "center", justifyContent: "center",
                background: sessionRefreshDone ? "rgba(74,222,128,0.15)" : "rgba(255,255,255,0.4)",
                border: "1px solid rgba(255,255,255,0.5)",
    ...
    <div
      ...
      style={{
        ...
        background: confirmDelete
          ? "rgba(239,68,68,0.06)"
          : isSelected ? "rgba(0,122,255,0.08)" : hovered ? "var(--bg-hover)" : "transparent",
    ...
    >
      {confirmDelete ? (
        ...
        <>
          ...
          {(() => {
            const style = getAvatarStyle(session.id);
            const letter = getAvatarLetter(title);
            return (
              <div
